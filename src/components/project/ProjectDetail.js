        ...
        <section class="text-gray-700 body-font  bg-white">
            <div class="container px-5 py-24 mx-auto">
                <div class="lg:w-4/5 mx-auto flex flex-wrap">
                    <img alt="portofilo aymar project" class="lg:w-1/2 w-full object-cover object-center rounded border border-gray-200" src={`${coverPicture}`} />
                    <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                        <h2 class="text-sm title-font text-gray-500 tracking-widest">projet</h2>
                        ...
                        <div class="flex">
                            ...
                            <a target={"_blank"} href={`${link}`} class="flex ml-auto text-white bg-blue-500 border-0 py-2 px-6 focus:outline-none hover:bg-blue-600 rounded">Aller vers projet</a>
