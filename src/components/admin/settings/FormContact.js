                ...
                <div role="alert" class="container-fluid w-full ">
                    <div class="w-full container-fluid relative py-8 px-5 md:px-10 bg-white dark:bg-gray-800 dark:border-gray-700 shadow-md rounded border border-gray-400">
                        <div class="w-full flex flex-row  justify-start text-gray-600 mb-3">
                            ...
                            <h2 class="text-gray-300 text-3xl"> Contact </h2>
                        </div>
                        <p class="text-gray-300">les information primaire</p>
                        ...
                        <div class="p-1">
                            ...
                            <div class="">
                                <label class="text-gray-800 dark:text-white  text-sm font-bold leading-tight tracking-normal">
                                    Nom de l{"'"} entreprise
                                </label>
                                <input type="text" class="mb-5 mt-2 text-gray-600 dark:bg-gray-900 dark:text-white dark:placeholder-gray-200 dark:border-gray-700 focus:outline-none focus:border focus:border-indigo-700 font-normal w-full h-10 flex items-center pl-3 text-sm border-gray-300 rounded border" placeholder="James" />
                            </div>
                            <div class="">
                                <label class="text-gray-800 dark:text-white  text-sm font-bold leading-tight tracking-normal">Description de l{"'"}entrerpise</label>
                        ...
                        <div class="p-1">
                            ...
                            <div class="">
                                <label class="text-gray-800 dark:text-white  text-sm font-bold leading-tight tracking-normal">email</label>
                            ...
                            <div class="">
                                <label class="text-gray-800 dark:text-white  text-sm font-bold leading-tight tracking-normal">Téléphone 1</label>
                                <textarea class="mb-5 mt-2 text-gray-600 dark:bg-gray-900 dark:text-white dark:placeholder-gray-200 dark:border-gray-700 focus:outline-none focus:border focus:border-indigo-700 font-normal w-full h-10 flex items-center pl-3 text-sm border-gray-300 rounded border" placeholder="James" />
                            </div>
                            <div class="">
                                <label class="text-gray-800 dark:text-white  text-sm font-bold leading-tight tracking-normal">Téléphone 2</label>
                                <textarea class="mb-5 mt-2 text-gray-600 dark:bg-gray-900 dark:text-white dark:placeholder-gray-200 dark:border-gray-700 focus:outline-none focus:border focus:border-indigo-700 font-normal w-full h-10 flex items-center pl-3 text-sm border-gray-300 rounded border" placeholder="James" />
                            </div>
                        </div>
                        ...
                        <div class="p-1">
                            ...
                            <div class="">
                                <label class="text-gray-800 dark:text-white  text-sm font-bold leading-tight tracking-normal">facebook</label>
                                <input type="text" id="name" class="mb-5 mt-2 text-gray-600 dark:bg-gray-900 dark:text-white dark:placeholder-gray-200 dark:border-gray-700 focus:outline-none focus:border focus:border-indigo-700 font-normal w-full h-10 flex items-center pl-3 text-sm border-gray-300 rounded border" placeholder="James" />
                            </div>
                            <div class="">
                                <label class="text-gray-800 dark:text-white  text-sm font-bold leading-tight tracking-normal">Youtube</label>
                                <input type="text" class="mb-5 mt-2 text-gray-600 dark:bg-gray-900 dark:text-white dark:placeholder-gray-200 dark:border-gray-700 focus:outline-none focus:border focus:border-indigo-700 font-normal w-full h-10 flex items-center pl-3 text-sm border-gray-300 rounded border" placeholder="James" />
                            </div>
                            <div class="">
                                <label class="text-gray-800 dark:text-white  text-sm font-bold leading-tight tracking-normal">instagram</label>
                                <input type="text" class="mb-5 mt-2 text-gray-600 dark:bg-gray-900 dark:text-white dark:placeholder-gray-200 dark:border-gray-700 focus:outline-none focus:border focus:border-indigo-700 font-normal w-full h-10 flex items-center pl-3 text-sm border-gray-300 rounded border" placeholder="James" />
                            </div>
                        </div>
