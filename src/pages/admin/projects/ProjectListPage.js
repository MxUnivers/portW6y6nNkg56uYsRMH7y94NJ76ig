    ...
    <div class="h-full ml-14 mt-14 mb-10 md:ml-64">
      ...
      <div class="flex-1 px-2 sm:px-3 p-4">
        <div class="flex justify-between items-center">
          <h3 class="text-3xl font-extralight text-white/50">Liste des Projets du site web </h3>
        ...
        <div class="mb-10 sm:mb-0 mt-10 grid gap-4 grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
          <a href={`/${routing.admin}/${routing.project_add}`} class="group bg-gray-900/30 py-20 px-4 flex flex-col space-y-2 items-center cursor-pointer rounded-md hover:bg-gray-900/40 hover:smooth-hover">
            {/* Nouveau service sutsite web  */}
            <a href={`/${routing.admin}/${routing.project_add}`} class="bg-gray-900/70 text-white/50 group-hover:text-white group-hover:smooth-hover flex w-20 h-20 rounded-full items-center justify-center" >
              <svg xmlns="http://www.w3.org/2000/svg" class="h-10 w-10" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1" d="M12 6v6m0 0v6m0-6h6m-6 0H6" />
              </svg>
            </a>
            <a class="text-white/50 group-hover:text-white group-hover:smooth-hover text-center" 
            href={`/${routing.admin}/${routing.project_add}`}
            >Nouveau projet</a>
          </a>
          <div class="relative group bg-gray-900 py-10 sm:py-20 px-4 flex flex-col space-y-2 items-center cursor-pointer rounded-md hover:bg-gray-900/80 hover:smooth-hover">
            ...
            <a href={`/${routing.admin}/${routing.project_edit}/:id`} class="bg-lime-500 hover:bg-lime-600 active:bg-lime-700 py-1 px-2 rounded-lg text-white">edit</a>
            <a href={`/${routing.admin}/${routing.project_delete}/:id`} class="bg-red-500 hover:bg-red-600 active:bg-red-700 py-1 px-2 rounded-lg text-white">delete</a>
            </p>
            <p class="absolute top-2 text-white/20 inline-flex items-center text-xs">22 like<span class="ml-2 w-2 h-2 block bg-green-500 rounded-full group-hover:animate-pulse"></span></p>
          </div>
          <div class="relative group bg-gray-900 py-10 sm:py-20 px-4 flex flex-col space-y-2 items-center cursor-pointer rounded-md hover:bg-gray-900/80 hover:smooth-hover">
