...
import { LoadAllMessagesArchives } from '../../../actions/api/message_action';
import { TbMessage2 } from "react-icons/tb";
import MessagesArchives from '../../../components/admin/archives/MessagesArchives';
import ServicesArchives from '../../../components/admin/archives/ServicesArchives';
import ProjectArchives from '../../../components/admin/archives/ProjectArchives';
        ...
        <div class="h-full ml-14 mt-14 mb-10 md:ml-64">
            ...
            <div class="flex-1 px-2 sm:px-3 p-4">
                ...
                <div class="flex justify-between items-center">
                    <h3 class="text-3xl font-extralight text-white/50">Archives </h3>
                ...
                <div class="mb-10 sm:mb-0 mt-10 ">
                    ...
                    <ul class="nav nav-tabs flex flex-wrap space-x-3" id="myTab" role="tablist">
                        <li class="nav-item" role="presentation">
                            <button onClick={() => { ShowTabContent(0) }} title="page d'accueil" class="nav-link flex flex-row justify-center active  px-2 py-1 rounded-lg bg-red-400 text-gray-700" id="home-tab" data-bs-toggle="tab" data-bs-target="#home" type="button" role="tab" aria-controls="home" aria-selected="true">
                                <TbMessage2 class="h-7 w-7 text-white " />
                            </button>
                        </li>
                        {
                            /*
