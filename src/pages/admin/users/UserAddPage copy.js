            ...
            <div class=" relative grid min-h-screen place-items-center">
                ...
                >retour</button>
                    ...
                    <form class="mt-6">
                        ...
                        <label for="password" class="block mt-2 text-xs font-semibold text-gray-200 uppercase">mot de passe</label>
                        ...
                        <label for="password-confirm" class="block mt-2 text-xs font-semibold text-gray-200 uppercase">Confirmer mot de passe</label>
